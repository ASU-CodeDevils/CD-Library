...
export type ComponentWithAs<TComponentProps = object> =
  React.FC<TComponentProps> & AsProps;

/** Components including the `className` prop. */
export type ComponentWithClassName<TComponentProps = object> = TComponentProps &
  ClassNameProps;

/** Components including props comprising a majority of custom components. */
export type BaseComponent<TComponentProps = object> = PropsWithRef<
  PropsWithChildren<TComponentProps & ClassNameProps & AsProps>
>;

/** Components with the base component props save `as`. */
export type BaseComponentWithoutAs<TComponentProps = object> = PropsWithRef<
  PropsWithChildren<TComponentProps & ClassNameProps>
>;
